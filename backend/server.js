...
// -----------------------------
// Route imports (cleaned — no duplicates)
// -----------------------------
...
const examRoutes = require('./routes/exam');        // use single name
...
const helpRoutes = require('./routes/help');        // renamed from helpRoutess
const resultsRouter = require('./routes/results');
const recurringRoutes = require('./routes/recurring');
const gamesRouter = require('./routes/games');      // declared once
const recycleRouter = require('./routes/recycle');  // declared once
...
app.use('/api/exams', examRoutes);           // single mount for exams
